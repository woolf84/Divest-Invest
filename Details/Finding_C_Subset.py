...
df_inc = pd.read_csv('incidents-chunks/incidents_details_true.csv', encoding='utf-8')
...
df_det['MATCH_TENTH_KM'] = match

df_det.to_csv('incidents-chunks/matching_details_subset.csv', encoding='utf-8')